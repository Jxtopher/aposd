...
PsAdaptivePursuit::PsAdaptivePursuit(std::shared_ptr<std::mt19937> mt_rand, unsigned int number_of_parameters,
					const double alpha, const double beta, const double p_min,
					const double p_max,
...
PsAdaptivePursuit::PsAdaptivePursuit(const PsAdaptivePursuit& c)
...
PsAdaptivePursuit::~PsAdaptivePursuit() {}

template<typename T>
unsigned int PsAdaptivePursuit::roulette_wheel(const T* array, unsigned int size, std::mt19937& mt_rand) {
...
ParameterSelection* PsAdaptivePursuit::clone() const { return new PsAdaptivePursuit(*this); }

void PsAdaptivePursuit::reset() {
...
///
void PsAdaptivePursuit::update(std::vector<std::pair<double, unsigned int>>& rewards) {
...
///
void PsAdaptivePursuit::update(std::pair<double, unsigned int>& rewards) {
...
void PsAdaptivePursuit::_selection_probability() {
...
std::vector<unsigned int> PsAdaptivePursuit::getParameter(const unsigned int number_of_nodes) {
...
unsigned int PsAdaptivePursuit::getParameter() {
	if(init_each_parameter < this->_number_of_parameters) {
...
std::string PsAdaptivePursuit::className() const { return "PsAdaptivePursuit"; }