...
WebAposd::WebAposd(cppcms::service& srv) : cppcms::rpc::json_rpc_server(srv) {
...
void WebAposd::echo(const std::string &msg) { 
...
// void WebAposd::ping(std::string msg) { 
//     DEBUG_TRACE("echo")
//     cppcms::json::value json;
...
/// @param msg 
///
void WebAposd::initialization(const std::string &msg) {
...
/// @param msg 
///
void WebAposd::learning(const std::string &msg) {
...
/// @param msg
///
void WebAposd::finish(const std::string &msg) {
    Json::Value data = stringAsjson(msg);
    cppcms::json::value answer;
