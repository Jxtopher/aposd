...
ClassBuilder::ClassBuilder(std::shared_ptr<std::mt19937> mt_rand) : _mt_rand(mt_rand) {}

std::unique_ptr<Topologies> ClassBuilder::topologies(const Json::Value& configuration) {
...
std::unique_ptr<ParameterSelection> ClassBuilder::parameterSelection(const Json::Value& configuration) {
...
std::unique_ptr<Launcher> ClassBuilder::launcher(const Json::Value& configuration) {
...
std::unique_ptr<RewardComputation<SOL>> ClassBuilder::rewardComputation(const Json::Value& configuration) {
	return std::make_unique<RewardComputation<SOL>>();
}

template<typename SOL>
std::unique_ptr<SolutionSelection<SOL>> ClassBuilder::solutionSelection(const Json::Value& configuration) {
